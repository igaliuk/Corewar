...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/05/22 11:37:03 by abodnar           #+#    #+#             */
/*   Updated: 2018/05/22 11:37:04 by abodnar          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				ft_print_fd(va_list ap, char *format, int fd)
{
	char		*buff;
	t_params	params;
	char		*res;
	...
	ret = (int)write(fd, res, ft_strlen(buff));
	ft_strdel(&buff);
	ft_strdel(&res);
	return (ret);
}
